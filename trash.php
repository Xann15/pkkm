...
if(isset($_POST['bayarTrash'])) {
    ...
    if(empty(trim($noPelanggan && $periode && $nominal ))) {
        ...
        header("refresh:0; url=trash.php");exit;
    }
...
<body>
    <div class="container mt-lg-5 mt-4 py-lg-2">
        <div class="header-history bg-light d-flex p-2" style="border-radius:30px; height: 80px">
            ...
            <img src="assets/img/trash.jpg" alt="Trash" class="rounded-circle">
            <p class="my-auto mx-3" style="font-size: 30px; font-family: fjalla one;">Trash Payment</p>
        </div>
        ...
        <div class="form mt-5 col-lg-8 mx-auto">
            <form action="" method="POST">
                ...
                <div class="text-center mt-4">
                    <button type="button" name="bayarTrash" id="bayarTrash" class="btn btn-danger mx-auto col-lg-6 col-md-8 col-10" data-bs-toggle="modal" data-bs-target="#modal">Bayar Sekarang</button>
                </div>
                ...
                <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content align-items-center p-5">
                            <input type="submit" name="bayarTrash" class="btn btn-danger mx-auto" value="Konfirmasi Pembayaran">
                        </div>
                    </div>
                </div>
            </form>
